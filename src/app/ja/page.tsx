      ...
      <footer className="py-12 text-gray-400" style={{ background: "linear-gradient(to bottom, #ffffff 0%, #1B4332 10%, #143728 40%, #0f2a1f 75%, #0a1a14 100%)" }}>
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-6 text-sm">
            <a href="/ja/terms" className="text-gray-400 hover:text-gray-300 transition-colors underline underline-offset-2">利用規約</a>
            <span className="text-gray-600">|</span>
            <a href="/ja/privacy" className="text-gray-400 hover:text-gray-300 transition-colors underline underline-offset-2">プライバシーポリシー</a>
          </div>
