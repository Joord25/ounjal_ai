...
第10条（Cookieの使用）
本サービスは、ユーザー体験の向上、設定の保存、利用パターンの分析のためにCookieを使用する場合があります。会員はブラウザの設定を通じてCookieを無効にすることができますが、一部の機能が正常に動作しない場合があります。

第11条（個人情報保護責任者）
個人情報保護責任者：Jooyong Lim（代表）
メール：ounjal.ai.app@gmail.com
電話：010-4824-2869
住所：大韓民国ソウル特別市冠岳区銀川路35ギル40-6

会員は個人情報に関する権利を行使するため、いつでも個人情報保護責任者に連絡することができます。
