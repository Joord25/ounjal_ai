...
아. AI 영양 코치 채팅 및 맞춤 식단 가이드 서비스 (프리미엄 전용)

제10조(유료 서비스 및 구독)

무료 플랜은 AI 운동 플랜 생성 횟수가 2회, AI 채팅이 3회로 제한됩니다.

프리미엄 구독 시 AI 맞춤 운동 플랜 무제한 생성, 세션별 AI 분석 리포트, 체중 변화 그래프 추적, 운동 히스토리 무제한 저장, AI 영양 코치 채팅 무제한 및 맞춤 식단 가이드 등 모든 기능을 이용할 수 있습니다.
...
회사 귀책 사유(시스템 오류, 중복 결제 등)로 인한 환불은 위 기한 제한 없이 가능합니다.
