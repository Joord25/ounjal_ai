...
구독은 매월 자동 갱신되며, 언제든지 취소할 수 있습니다. 결제 수단은 지역에 따라 자동 분기됩니다: 한국 사용자는 카카오페이(PortOne), 해외 사용자는 신용카드(Paddle).
...
PortOne(포트원) / 카카오페이 주식회사: 한국 사용자 프리미엄 구독 결제 처리 / 전송 데이터: 사용자 식별자(UID), 이메일, 표시 이름, 빌링키 / 법정 보유기간까지

Paddle.com Market Ltd.: 해외 사용자 프리미엄 구독 결제 처리 (Merchant of Record) / 전송 데이터: 사용자 식별자(UID), 이메일 / 법정 보유기간까지
